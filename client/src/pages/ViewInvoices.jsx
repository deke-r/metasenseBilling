...
const ViewInvoices = () => {
    ...
    const [selectedInvoice, setSelectedInvoice] = useState({
        ...
        clientAddress: '123 Test St, Demo City',
        buyerGstin: '27ABCDE1234F1Z5',
        buyerStateName: 'StateName',
        buyerStateCode: '27',
        items: [
            { description: 'Test Item 1', hsnSac: '123456', quantity: 2, unitPrice: 100, perUnit: 'Nos' },
            { description: 'Test Item 2', hsnSac: '789012', quantity: 1, unitPrice: 500, perUnit: 'Nos' }
        ],
        taxRate: 18,
        sellerName: 'Sense Projects Pvt Ltd',
        sellerGstin: '07AAPCS9265G1ZH',
        sellerStateName: 'Delhi',
        sellerStateCode: '07',
        sellerEmail: 'info@senseprojects.in',
        regdAddress: 'Regd Address Line 1',
        offcAddress: 'Office Address Line 1',
    })
